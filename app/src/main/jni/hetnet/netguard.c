...
jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    const char *packet = "android_network/hetnet/vpn_service/Packet";
    clsPacket = jniGlobalRef(env, jniFindClass(env, packet));

    const char *allowed = "android_network/hetnet/vpn_service/Allowed";
    clsAllowed = jniGlobalRef(env, jniFindClass(env, allowed));

    const char *rr = "android_network/hetnet/vpn_service/ResourceRecord";
    clsRR = jniGlobalRef(env, jniFindClass(env, rr));

    const char *usage = "android_network/hetnet/vpn_service/Usage";
...
Java_android_1network_hetnet_vpn_1service_ServiceSinkhole_jni_1init(JNIEnv *env, jobject instance) {

    log_android(ANDROID_LOG_INFO, "JNI init");
...
JNIEXPORT void JNICALL
Java_android_1network_hetnet_vpn_1service_ServiceSinkhole_jni_1start(
        JNIEnv *env, jobject instance, jint tun, jboolean fwd53, jint rcode, jint loglevel_) {

    log_android(ANDROID_LOG_INFO, "JNI start");
...
JNIEXPORT void JNICALL
Java_android_1network_hetnet_vpn_1service_ServiceSinkhole_jni_1stop(
...
Java_android_1network_hetnet_vpn_1service_ServiceSinkhole_jni_1get_1mtu(JNIEnv *env, jobject instance) {
    return get_mtu();
}

JNIEXPORT jintArray JNICALL
Java_android_1network_hetnet_vpn_1service_ServiceSinkhole_jni_1get_1stats(JNIEnv *env, jobject instance) {
...
JNIEXPORT void JNICALL
Java_android_1network_hetnet_vpn_1service_ServiceSinkhole_jni_1pcap(
...
JNIEXPORT void JNICALL
Java_android_1network_hetnet_vpn_1service_ServiceSinkhole_jni_1socks5(JNIEnv *env, jobject instance, jstring addr_,
...
JNIEXPORT void JNICALL
Java_android_1network_hetnet_vpn_1service_ServiceSinkhole_jni_1done(JNIEnv *env, jobject instance) {
...
Java_android_1network_hetnet_vpn_1service_Util_jni_1getprop(JNIEnv *env, jclass type, jstring name_) {
    const char *name = (*env)->GetStringUTFChars(env, name_, 0);
...
Java_android_1network_hetnet_vpn_1service_Util_is_1numeric_1address(JNIEnv *env, jclass type, jstring ip_) {
    jboolean numeric = 0;
...
// -- call the logPacket method in Java and pass the packet
void log_packet(const struct arguments *args, jobject jpacket) {
    ...
    const char *signature = "(Landroid_network/hetnet/vpn_service/Packet;)V";

    // -- get the ID of logPacket method in Java
    if (midLogPacket == NULL)
        midLogPacket = jniGetMethodID(args->env, clsService, "logPacket", signature);

    // -- call the logPacket method in Java
...
void dns_resolved(const struct arguments *args,
    ...
    const char *signature = "(Landroid_network/hetnet/vpn_service/ResourceRecord;)V";
...
struct allowed *is_address_allowed(const struct arguments *args, jobject jpacket) {
    ...
    const char *signature = "(Landroid_network/hetnet/vpn_service/Packet;)Landroid_network/hetnet/vpn_service/Allowed;";
...
void account_usage(const struct arguments *args, jint version, jint protocol,
    ...
    log_android(ANDROID_LOG_INFO, "account usage");

    jclass clsService = (*args->env)->GetObjectClass(args->env, args->instance);

    const char *signature = "(Landroid_network/hetnet/vpn_service/Usage;)V";
