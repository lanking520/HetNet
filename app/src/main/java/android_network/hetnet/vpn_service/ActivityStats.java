...
public class ActivityStats extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Show Statistics Log");
        ...
        adapter = new AdapterStats(this, DatabaseHelper.getInstance(this).getAccess());
            ...
            case R.id.menu_traffic_clear:
                new AsyncTask<Object, Object, Object>() {
                    ...
                    protected Object doInBackground(Object... objects) {
                        DatabaseHelper.getInstance(ActivityStats.this).clearAccess();
                        return null;
                    }
